...
import { Deal, Account, DealStage, Task, TaskType, TaskPriority, Interaction, InteractionType, Mailbox, Message } from './types.ts';
...
export const mockAccounts: Account[] = [
  { id: 'acc-1', name: 'Volkswagen AG', domain: 'vw.de', industry: 'Automotive', size: '10k+', notes: 'Interesse an KI-Prozess-Automatisierung für Logistik.' },
  { id: 'acc-2', name: 'Zalando SE', domain: 'zalando.io', industry: 'E-Commerce', size: '5k-10k', notes: 'Prüfen LLM-Einsatz im Customer Support.' },
  { id: 'acc-3', name: 'Siemens Healthineers', domain: 'siemens.com', industry: 'Healthcare', size: '10k+', notes: 'Security-Audit für KI-Modelle erforderlich.' },
  { id: 'acc-4', name: 'HypoVereinsbank', domain: 'hvb.de', industry: 'Finance', size: '1k-5k', notes: 'Compliance-Checks via Agenten-System.' },
];

export const mockDeals: Deal[] = [
  { id: 'deal-1', accountId: 'acc-1', name: 'Workflow Audit: Supply Chain', stage: DealStage.CALL_BOOKED, ownerId: 'cedric', value: 18500, nextStepDate: new Date().toISOString(), tags: ['urgent', 'audit'], score: 92 },
  { id: 'deal-2', accountId: 'acc-2', name: 'Custom LLM Support Bot', stage: DealStage.QUALIFIED, ownerId: 'cedric', value: 45000, nextStepDate: new Date(Date.now() + 86400000).toISOString(), tags: ['high-potential', 'build'], score: 78 },
  { id: 'deal-3', accountId: 'acc-3', name: 'AI Security Readiness', stage: DealStage.OFFER_SENT, ownerId: 'cedric', value: 12000, nextStepDate: new Date(Date.now() + 172800000).toISOString(), tags: ['follow-up'], score: 65 },
  { id: 'deal-4', accountId: 'acc-4', name: 'AI Ops Retainer Q4', stage: DealStage.WON, ownerId: 'cedric', value: 8500, nextStepDate: new Date(Date.now() + 345600000).toISOString(), tags: ['retainer'], score: 100 },
];
