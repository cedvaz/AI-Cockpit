...
import { Task, TaskType, TaskPriority, Deal, Company } from '../types.ts';
...
const TasksManager: React.FC<TasksManagerProps> = ({ tasks, deals, companies, onToggleTask, onSelectDeal, onStartPowerHour }) => {
