...
import { Task, Deal, Company } from '../types.ts';
...
const PowerHour: React.FC<PowerHourProps> = ({ isOpen, onClose, tasks, deals, companies, onCompleteTask }) => {
        ...
        <div className="space-y-10 animate-in slide-in-from-left-8 duration-500">
          ...
          <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 space-y-6">
            ...
            <p className="text-slate-300 text-lg leading-relaxed font-medium">
              Dieser Task ist entscheidend für den Abschluss. {company?.name} wartet auf das Feedback zu den Security-Requirements.
            </p>
